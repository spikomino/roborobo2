...
static void versionInfos()
{
	std::cout << std::endl;
	std::cout << " =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=" << std::endl;
	std::cout << " =-=-=-=-=-=-= Roborobo! =-= ver.2 =-=" << std::endl;
	std::cout << " =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=" << std::endl;
	std::cout << std::endl;
	std::cout << "  description     : A lightweight collective robots/agents simulator written in C++/SDL." << std::endl;
	std::cout << "  author          : nicolas.bredeche(at)upmc.fr" << std::endl;
	std::cout << "  started         : [Ver.1: 12/2008] [Ver.2: 09/2013]" << std::endl << std::endl;

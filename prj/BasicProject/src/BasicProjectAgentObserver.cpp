...
BasicProjectAgentObserver::BasicProjectAgentObserver( )
{
}

BasicProjectAgentObserver::BasicProjectAgentObserver( RobotWorldModel *__wm )
{
	_wm = __wm;
}
...
void BasicProjectAgentObserver::reset()
{
	// nothing to do.
}

void BasicProjectAgentObserver::step()
{

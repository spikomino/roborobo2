...
#ifndef PRJMATESELECTIONCONTROLLER_H
#define PRJMATESELECTIONCONTROLLER_H
...
class PrjMateSelectionController : public Controller
{
	private:
		int _iteration;
...
//        void setAliveStatus( bool isAlive ) { _isAlive = isAlive; }
	...
	public:
        ...
        PrjMateSelectionController(RobotWorldModel *wm);
		~PrjMateSelectionController();

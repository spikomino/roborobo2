...
PrjMateSelectionAgentObserver::PrjMateSelectionAgentObserver( RobotWorldModel *wm )
{
    _wm = (RobotWorldModel*)wm;

}

PrjMateSelectionAgentObserver::~PrjMateSelectionAgentObserver()
{
	// nothing to do.
}

void PrjMateSelectionAgentObserver::reset()
{
	// nothing to do.
}

void PrjMateSelectionAgentObserver::step()
{

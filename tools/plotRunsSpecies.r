...
row.names(meanFitness) <- rep('[species:',length(meanFitness))
	write.table(meanFitness,paste(sprintf(paste("%03d-meanFitPerRobot-",exp,sep=""),i),".species",sep=""),row.names= TRUE,col.names=FALSE,sep="",quote=FALSE)
}

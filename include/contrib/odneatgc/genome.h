...
namespace ODNEATGC
{
  ...
  extern "C"
  {
    ...
    extern double     mutateOnlyProbGc; // Prob. of a non-mating reproduction
    extern double     mutateLinkWeightsProbGc;
    extern double     mutateToggleEnableProbGc;
    extern double     mutateGeneReenableProbGc;
    extern double     mutateAddNodeProbGc;
    extern double     mutateAddLinkProbGc;
    extern double     mateOnlyProbGc; // Prob. of mating without mutation
    extern double     recurOnlyProbGc;  // Probability of forcing selection of ONLY links that are naturally recurrent
    extern int        newStructureTriesGc;  // Number of tries mutate_add_link or mutate_add_node will attempt to find an open link

    extern double     coefEGc;
    extern double     coefDGc;
    extern double     coefWGc;

    extern double     rangeWGc;

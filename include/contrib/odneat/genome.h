#ifndef _ODNEATGENOME_H_
#define _ODNEATGENOME_H_
...
namespace ODNEAT
{
  ...
  public:
    ...
    Genome *mutate(float sigma,int idNewGenome);
  ...
  extern "C"
  {
    ...
    extern double     mutateOnlyProb; // Prob. of a non-mating reproduction
    ...
    extern double     mateOnlyProb; // Prob. of mating without mutation
    extern double     recurOnlyProb;  // Probability of forcing selection of ONLY links that are naturally recurrent
    extern int        newStructureTries;  // Number of tries mutate_add_link or mutate_add_node will attempt to find an open link
